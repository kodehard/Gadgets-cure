...
public class DbProvider extends ContentProvider {
    ...
    static {
        ...
        // of the pets table.
        sUriMatcher.addURI(DbContract.CONTENT_AUTHORITY, DbContract.PATH_RECEIPTS, PETS);
        ...
        sUriMatcher.addURI(DbContract.CONTENT_AUTHORITY, DbContract.PATH_RECEIPTS + "/#", PET_ID);
    }
    ...
    private int updateReceipt(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(DbContract.DbEntry.TABLE_NAME, values, selection, selectionArgs);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PETS:
                ...
                rowsDeleted = database.delete(DbContract.DbEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case PET_ID:
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case PETS:
                return DbContract.DbEntry.CONTENT_LIST_TYPE;
            case PET_ID:
                return DbContract.DbEntry.CONTENT_ITEM_TYPE;
            default:
